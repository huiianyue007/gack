        ...
        <div v-loading="loadingTab">
            <el-table :data="tableData" border style="width: 100%" ref="multipleTable" @select-all='selectBox' @select='selectBox'>
                ...
                <el-table-column label="上架" width="100" align="center">
                    <template slot-scope="scope">
                        <el-button size="small" type="primary" @click="shelves(scope.row.id)">上架</el-button>
                    </template>
                </el-table-column>
...
export default {
    ...
    methods: {
        ...
        editRouter(commId) {
            ...
            this.$store.state.comId = commId;

            this.$store.state.stateId = '5';
        },
        // 上架
        shelves(id) {
            this.$confirm('是否确认选中商品上架？', '提示', {

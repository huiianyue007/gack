<template>
    <div>
        <quill-editor v-model="content" ref="myTextEditor" :options="editorOption" @change="onChange" class="con">
...
export default {
    ...
    created: function () {
        this.editorOption.modules.toolbar = '#' + this.toolbars;
    ...
    methods: {
        ...
        onFileChange(e) {
            ...
            data.append("companyLogo", fileInput.files[0]);
            ...
            xhr.onload=function () {
              if(xhr.status==200){
                self.editor.insertEmbed(self.editor.getSelection().index, 'image', xhr.response.data);
              }
            }
